...
# 変数urlにSUUMOホームページのURLを格納する
url = 'https://product.starbucks.co.jp/food/?page={}'
...
contents = soup.find_all('div', class_="mainContents notExNav beverageProductList")
...
article = content.find('article', class_="productList productListGrid")
print(article)
...
season = article.find('div', class_="seasonalRecommendations")
print(season)
...
age = detail.find('li', class_="col recommend ").text
